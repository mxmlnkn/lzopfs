...
size_t endsWith( const std::string& haystack,
...
size_t hasExtension( const std::string& name,
...
bool replaceExtension( std::string&       name,
                       const std::string& ext,
...
bool removeExtension( std::string&       name,
                      const std::string& ext )
{
    size_t pos = hasExtension( name, ext );
    if ( pos == std::string::npos ) {
