...
lzma_ret PixzFile::code( lzma_stream&      s,
                         const FileHandle& fh,
                         off_t             off )
const
{
...
void PixzFile::decompressBlock( const FileHandle& fh,
                                const Block&      b,
                                Buffer&           ubuf ) const
{
...
std::string PixzFile::destName() const
{
    ...
    if ( replaceExtension( base, "tpxz", "tar" ) ) {
        return base;
    }
    if ( replaceExtension( base, "txz", "tar" ) ) {
        return base;
    }
    if ( removeExtension( base, "pxz" ) ) {
        return base;
    }
    if ( removeExtension( base, "xz" ) ) {
        return base;
    }
    return base;
}
